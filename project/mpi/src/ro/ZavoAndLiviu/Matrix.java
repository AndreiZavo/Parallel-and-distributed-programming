...
public final class Matrix implements Serializable {
    ...
    public static Matrix fromFile() throws IOException {
        ...
        int freeI = -1, freeJ = -1;
        Scanner scanner = new Scanner(new BufferedReader(new FileReader("D:\\UBB\\An III\\Sem 1\\Parallel and Distributed programming\\Labs\\AlexPopa Puzzle\\pdp\\project\\mpi\\matrix.in")));
        for (int i = 0; i < 4; i++) {
            for (int j = 0; j < 4; j++) {
